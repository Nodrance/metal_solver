...
# Credits/License:
All code written by me (Nodrance) except for proliferation code which was written by crazybot27 and the decimal to fraction function which is credited inline and was integrated into the project by crazybot27. Images are from Opus Magnum by Zachtronics, used without permission. Icon was made by me. Fonts are from windows. License is CC-BY-SA for everything written by me, which means "do whatever you want as long as you give credit, and if you make something using this then it also has to be CC-BY-SA".